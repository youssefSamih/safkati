...
export const API_COMMISSIONS =`${IP}/api_rest/smsar/commissions.php`;

export const API_PROJECTS = `${IP}/api_rest/project/read.php`;
export const API_DECLARE_CLIENT = `${IP}/api_rest/project/declare_client.php`;
export const API_PROJECT_INFO = `${IP}/api_rest/project/read_one.php`;
